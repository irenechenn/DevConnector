...
router.delete('/:id', auth, async (req, res) => {
  try {
    ...
    //Check if the post is by THIS user
...
router.put('/like/:id', auth, async (req, res) => {
  try {
    ...
    //Check if the post has already been lked by THIS user
...
router.put('/unlike/:id', auth, async (req, res) => {
  try {
    ...
    //Check if the post has already been lked
    if (
...
router.delete('/comment/:id/:comment_id', auth, async (req, res) => {
  try {
    ...
    //Check if it is same User that created the comment
